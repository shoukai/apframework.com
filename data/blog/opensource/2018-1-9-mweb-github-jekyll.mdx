...
date: '2018-01-08'
tags: ['环境搭建', 'GitHub Pages', 'Blog']
draft: false
summary: 'Jekyll、Github.io、七牛云 构建个人博客'
---
...
![blog-github-create](http://cdn.apframework.com/blog-github-create.jpg)
...
![blog-jekyll-new](http://cdn.apframework.com/blog-jekyll-new.jpg)
...
![blog-github-clean-blog](http://cdn.apframework.com/blog-github-clean-blog.jpg)
...
![blog-github-cname](http://cdn.apframework.com/blog-github-cname.jpg)

**域名提供商部分**

本文使用的是阿里云提供的云解析DNS，添加记录如下图所示。

![blog-aliyun-cname](http://cdn.apframework.com/blog-aliyun-cname.jpg)
...
![blog-qiniu-new](http://cdn.apframework.com/blog-qiniu-new.jpg)

申请存储空间，本文存储空间为mweb（即为BucketName），申请成功后管理界面如下：

![blog-qiniu-bucket](http://cdn.apframework.com/blog-qiniu-bucket.jpg)
...
![blog-qiniu-mweb](http://cdn.apframework.com/blog-qiniu-mweb.jpg)
