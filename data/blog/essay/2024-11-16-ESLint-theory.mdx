---
title: ESLint 概念及原理探索
date: '2024-11-16'
tags: ['ESLint', 'JavaScript', '随手记']
draft: false
summary: 'ESLint：可配置的 JavaScript 检查器'
---
...
![image.png](/static/images/2024-11-16-ESLint-theory/image.png)

代码转换：支持使用 Transform 插件来转换代码，用户可以添加或修改 Prettier 参数来观察代码如何被转换。

![image.png](/static/images/2024-11-16-ESLint-theory/image%201.png)
...
![image.png](/static/images/2024-11-16-ESLint-theory/image%202.png)
...
![image.png](/static/images/2024-11-16-ESLint-theory/image%203.png)

以 **`no-dupe-else-if`** 规则为例。链接：https://zh-hans.eslint.org/docs/latest/rules/no-dupe-else-if

展示正确和错误的规则说明

![image.png](/static/images/2024-11-16-ESLint-theory/image%204.png)
...
- Lint：[https://zh.wikipedia.org/zh-cn/Lint](https://zh.wikipedia.org/zh-cn/Lint)
- ESLint 文档：[https://zh-hans.eslint.org/docs/latest/](https://zh-hans.eslint.org/docs/latest/use/core-concepts)
- 抽象语法树：[https://zh.wikipedia.org/wiki/抽象語法樹](https://zh.wikipedia.org/wiki/%E6%8A%BD%E8%B1%A1%E8%AA%9E%E6%B3%95%E6%A8%B9)
- AST Explorer：[https://astexplorer.net/](https://astexplorer.net/)
- espree：[https://github.com/eslint/js/tree/main/packages/espree](https://github.com/eslint/js/tree/main/packages/espree)