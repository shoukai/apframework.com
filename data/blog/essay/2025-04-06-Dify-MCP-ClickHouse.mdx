---
title: Dify 中使用 MCP 协议访问 ClickHouse 搭建记录
date: '2025-04-06'
tags: ['Dify', 'MCP', 'ClickHouse', 'ECharts', 'RAG', "随手记"]
draft: false
summary: '在 Dify 中，使用 MCP 及 MCP Proxy 访问 ClickHouse 搭建过程记录'
---


![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%201.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%202.png)

目前公司处于创业期，融资情况（20250406），公司以 Dify 产品为主，后续会有持续的商业资源投入，开源社区无人维护风险较低。

![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%203.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%204.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%205.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%206.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%207.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image11.png)

### 2.6 RAG 配置

为了让大模型更好的理解 SQL，可以将 ClickHouse 的建表语句导入到了知识库中

![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/74eb7ab0-5451-4e46-8d00-40717c742431.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%208.png)
...
![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%209.png)

### 3.4 效果验证

本文使用 Dify 的对话框，通过自然语言的方式，输入用户需求，大模型理解后，输出 ClickHouse 的 SQL 语句，Dify 通过 MCP 协议访问 ClickHouse 并得到查询结果，根据结果生成图表和数据情况分析。

![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image12.png)

预祝配置过程中顺利

![image.png](/static/images/2025-04-06-Dify-MCP-ClickHouse/image%2010.png)
Photo by [Luke Thornton](https://unsplash.com/@lukethornton?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash) on [Unsplash](https://unsplash.com/photos/a-sign-that-says-well-done-you-did-it-XD0v0OezcQ0?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)